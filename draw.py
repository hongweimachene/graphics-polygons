...
def draw_polygons( polygons, screen, color ):
    p = 0
    ematrix = []
    while p < len(polygons):
        add_edge(ematrix, polygons[p][0], polygons[p][1], polygons[p][2], polygons[p+1][0], polygons[p+1][1], polygons[p+1][2])
        add_edge(ematrix, polygons[p+1][0], polygons[p+1][1], polygons[p+1][2], polygons[p+2][0], polygons[p+2][1], polygons[p+2][2])
        add_edge(ematrix, polygons[p+2][0], polygons[p+2][1], polygons[p+2][2],polygons[p][0], polygons[p][1], polygons[p][2])
        p += 3
    draw_lines(ematrix, scren, color)
